...
public class Demo {
	...
	public static void main(String[] args) {
		...
		testList.addCourse(5, new Course("MATH121","Calc 1",500));
		testList.addCourse(4, new Course("MATH122","Calc 2",350));
		testList.addCourse(11, new Course("MATH223","Calc 3",200));			//Adding course which is out of bounds (will be added to the end)
				
		testList.changeCapacity("MATH122", 400);		//Using the changeCapacity() method to change the capacity of class to 400
				
		testList.removeCourse(9);   					//Removing the course at index 3 (Math 121)
		
		System.out.println(testList.getCourseWithIndex(100));  //Printing the course at index 3 (Course Object has overridden toString() method) 
		System.out.println();
