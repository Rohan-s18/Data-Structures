...
public class Map {
	...
	public static void main(String[] args) {
		...
		//First Test Case
		Map cwruMap = new Map(2);
		System.out.println("\t\t\t\t\t\t\t\t\t\t\t" + "First Test Case");
		System.out.println("\n");
		//Adding the buildings
		cwruMap.addBuilding("PB Lewis");
		cwruMap.addBuilding("Tinkham Veale");
		cwruMap.addBuilding("KSL");
		cwruMap.addBuilding("Tomlinson");
		cwruMap.addBuilding("Crawford Hall");
		cwruMap.addBuilding("Strosacker");
		cwruMap.addBuilding("Schmitt");
		cwruMap.addBuilding("Nursing Research Building");
		
		//Adding the roads
		cwruMap.addRoad("PB Lewis", "Tinkham Veale", 10);
		cwruMap.addRoad("PB Lewis", "Nursing Research Building", 30);
		cwruMap.addRoad("KSL", "Crawford Hall", 20);
		cwruMap.addRoad("Tinkham Veale", "KSL", 5);
		cwruMap.addRoad("Crawford Hall", "Tomlinson", 5);
		cwruMap.addRoad("Tinkham Veale", "Tomlinson", 35);
		cwruMap.addRoad("Crawford Hall", "Strosacker", 15);
		cwruMap.addRoad("Strosacker", "Schmitt", 10);
		cwruMap.addRoad("Schmitt", "Nursing Research Building", 20);
		
		cwruMap.printGraph();
		System.out.println("\n");
		
		cwruMap.removeBuilding("Nursing Research Building");
		cwruMap.printGraph();
		System.out.println("\n");
		
		LinkedList<String> addBuildingList = new LinkedList<String>();
		addBuildingList.add("PB Lewis");
		addBuildingList.add("Tinkham Veale");
		addBuildingList.add("Strosacker");
		addBuildingList.add("Schmitt");
		cwruMap.addRoads("Strosacker", addBuildingList, 15);
		cwruMap.removeRoad("Tinkham Veale", "Tomlinson");
		cwruMap.printGraph();
		System.out.println("\n");
		
		int x = cwruMap.shortestLength("PB Lewis", "Schmitt");
		//cwruMap.printSolution(cwruMap.dj);
		cwruMap.shortestLengthPrint("PB Lewis", "Schmitt", x);
		System.out.println("\n");
		
		List<String> myList = cwruMap.shortestPath("PB Lewis", "Crawford Hall");
		cwruMap.shortestPathPrint(myList);
		System.out.println("\n");
		
		System.out.println("Minimum Total Length: " + cwruMap.minimumTotalLength());
		System.out.println("\n");
		
		System.out.println("Second Shortest Length between Tinkham Veale and Strosacker is: " + cwruMap.secondShortestPath("Tinkham Veale","Strosacker"));
		System.out.println("\n");
		...
		int temp = midwestMap.shortestLength("Buffalo", "Toledo");
		midwestMap.shortestLengthPrint("Buffalo", "Toledo", temp);
